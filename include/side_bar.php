            ...
            <div class="scroll-sidebar">
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        ...
                        <p class="profile-text m-t-15 font-16"><a href="javascript:void(0);"> Hanna Chanda</a></p>
                    </div>
                </div>
                ...
                <div class="p-30">
                    <span class="hide-menu">
                        <a href="javascript:void(0);" target="_blank" class="btn btn-success">Buy Cyn Admin</a>
